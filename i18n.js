const TRANSLATIONS = {
  es: {
    ...
    'footer.by':             'by Libia y Marta',
    'footer.familia':        'Un emprendimiento familiar · Medellín, Colombia',
    'footer.info':           'Pagás por Nequi y por WhatsApp te llega tu pedido organizado y listo para despachar — te ayudamos con todo lo que necesités para el pago y el envío.',
  ...
  en: {
    ...
    'footer.info':           'Pay with Nequi — your order arrives on WhatsApp organized and ready to ship, and we\'ll help you with any payment or delivery questions.',
